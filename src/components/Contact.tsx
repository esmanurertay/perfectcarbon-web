    ...
    <section ref={sectionRef} className="w-full bg-gradient-to-r from-[#090909] to-red-500 pt-32 pb-40 px-6 md:px-12 relative overflow-hidden text-white">
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start relative z-10">
        ...
        <div className={`lg:col-span-5 flex flex-col items-start text-left transition-all duration-1000 ${isInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
          ...
          <p className="text-sm text-neutral-400 font-normal max-w-sm leading-relaxed mb-12">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <a href="mailto:info@perfectcarbonrapier.com" className="text-base font-medium text-white hover:text-white/80 transition-colors border-b border-white/10 pb-0.5">
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 w-full">
              <div className="flex flex-col items-start w-full relative group">
                ...
                />
                {/* Odaklanıldığında zemindeki kırmızıyla pürüzsüz parlayan saf beyaz çizgi detayı */}
