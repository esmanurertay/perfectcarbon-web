...
const allProductsConfig: ProductConfig[] = [
  { id: 1, brand: 'Van de Wiele', translationKey: 'p1', image: '/images/vdw-mekik.png' },
  { id: 2, brand: 'Dornier', translationKey: 'p2', image: '/images/dornier-disli.png' },
  { id: 3, brand: 'Schönherr', translationKey: 'p3', image: '/images/schonherr-makas.png' },
  { id: 4, brand: 'Van de Wiele', translationKey: 'p4', image: '/images/vdw-sis.png' },
  { id: 5, brand: 'Dornier', translationKey: 'p5', image: '/images/dornier-serit.png' },
  { id: 6, brand: 'Schönherr', translationKey: 'p6', image: '/images/schonherr-disli.png' },
  { id: 7, brand: 'Itema', translationKey: 'p7', image: '/images/itema-kafa.png' },
];
...
export default function ProductsSection() {
  ...
  // Seçilen ürünün config durumunu tutan state
  ...
  // Modal açıkken body kaymasını engelleme
  useEffect(() => {
    if (selectedProduct) {
      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="w-full flex items-end justify-between border-b border-neutral-100 pb-5 mb-8">
          <div className="text-left">
            ...
            <h2 className="text-2xl md:text-3xl font-normal tracking-tight text-black font-sans">
              {t('title')}
            </h2>
          </div>
        ...
        <div className="w-full relative group">
          ...
          >
            {allProductsConfig.map((product) => {
              const productName = t(`names.${product.translationKey}`);
          ...
          >
            ...
            <div className="w-full aspect-square max-h-[280px] bg-neutral-50/50 border border-neutral-100 rounded-2xl flex items-center justify-center p-8 relative">
              <img 
                ...
                alt={t(`names.${selectedProduct.translationKey}`)} 
            ...
            <div className="text-center flex flex-col items-center">
              ...
              <h3 className="text-2xl font-normal text-black tracking-tight font-sans">
                {t(`names.${selectedProduct.translationKey}`)}
              </h3>
            </div>
